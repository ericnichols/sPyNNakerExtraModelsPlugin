"""
stocastic intergrate and fire component
"""
...
class StocasticIntegrateAndFireComponent(AbstractModelComponent):
    ...
    def __init__(self, v_init, tau_m, cm, i_offset, atoms, v_rest, v_reset,
                 v_thresh, tau_refrac, du_th, tau_th, theta, t_refract_scale=10):
    ...
    @du_th.setter
    def du_th(self, new_value):
        """
        setter for the du_th value
        :param new_value:
        :return:
        """
        self._du_th_inv = new_value

    @tau_th.setter
    def tau_th(self, new_value):
        """
        setter for the tau_th param
        :param new_value:
        :return:
        """
        self._tau_th_inv = new_value
